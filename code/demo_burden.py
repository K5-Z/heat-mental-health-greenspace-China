...
for p, col_name in zip(["obs", "pot", "mit"], ["observed", "potential", "mitrted"]):
...
keep_columns = [
    "NAME", "year", "month",
    "observed_total", "potential_total", "mitrted_total",
    "observed_per100k", "potential_per100k", "mitrted_per100k"
]
