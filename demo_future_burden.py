...
# =====================================================
# NOTE
# This script is a simplified demonstration of the future
# burden projection workflow. For demonstration purposes,
# future cooling capacity is approximated by mapping the
# historical cooling capacity of the same day-of-year
# (column 'time': values 1–365).
#
# In the full study, future green-space cooling capacity
# was dynamically reconstructed using the machine-learning
# model described in the manuscript, driven by projected
# temperatures and static geographic features.
#
# Leap year day (366) is mapped to day 365 to ensure
# consistent alignment with historical cooling records. 
# =====================================================
...
def run_full_analysis(mode='Climate-plus-population'):
    ...
    Note:
    This demo uses an all-age exposure-response curve and total population inputs
    for both modes. In the full study, the climate-only scenario used the
    total-population exposure-response function with baseline population fixed over
    time, whereas the climate-plus-population scenario used age-specific
    exposure-response functions combined with age-stratified future population
    projections to account for population ageing.
    """
    ...
    for ssp in cfg.SSP_SCENARIOS:
        ...
        tem_pot = tem_obs + future_df['cooling_capacity']
